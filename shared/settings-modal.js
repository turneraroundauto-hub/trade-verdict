import { TIMEZONES, LINK_SITES, getTzPref, setTzPref, getLinkSitePref, setLinkSitePref, getCustomTemplate, setCustomTemplate, buildTemplateFromExample, detectTickerInUrl } from './prefs.js?v=5';
